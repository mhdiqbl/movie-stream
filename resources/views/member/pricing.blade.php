                ...
                <div class="mt-[70px] flex justify-center gap-[40px] flex-wrap">
                    ...
                    <div class="pricing-card">
                        <p class="text-stream-dark font-medium text-base">
                            {{ ucwords($standardPackage->name) }}
                        </p>
                        <div class="text-3xl text-stream-dark font-semibold my-1">
                            Rp {{ number_format($standardPackage->price) }}
                        </div>
                        ...
                        <div class="flex flex-col gap-6">
                            ...
                            <div class="flex items-center justify-between gap-3">
                                    <span class="li-benefits">
                                        {{ $standardPackage->max_users }} Users Limits
                                    </span>
                        ...
                        <form action="{{ route('member-transaction-store') }}" method="POST">
                            @csrf
                            <input type="hidden" name="package_id" value="{{ $standardPackage->id }}">
                            <button type="submit"
                    ...
                    <div class="pricing-card">
                        <p class="text-stream-dark font-medium text-base">
                            {{ ucwords($goldPackage->name) }}
                        </p>
                        <div class="text-3xl text-stream-dark font-semibold my-1">
                            Rp {{ number_format($goldPackage->price) }}
                        </div>
                        <p class="text-sm text-stream-gray">
                            /bulan
                        </p>
                        ...
                        <div class="flex flex-col gap-6">
                            ...
                            <div class="flex items-center justify-between gap-3">
                                    <span class="li-benefits">
                                        {{ $goldPackage->max_users }} Users Limits
                                    </span>
                                <img src="{{ asset('stream/assets/images/ic_check.svg') }}" alt="stream" />
                            </div>
                            <!-- benefits -->
                        ...
                        <form action="{{ route('member-transaction-store') }}" method="POST">
                            @csrf
                            <input type="hidden" name="package_id" value="{{ $goldPackage->id }}">
                            <button type="submit"
