...
<div class="font-poppins flex relative pt-20 px-3 h-screen">
    ...
    <span class="fixed -z-10 top-0 left-0">
            <img src="{{ asset('stream/assets/images/success_ellipse_green.svg') }}" alt="stream" />
        </span>
    <span class="fixed -z-10 bottom-0 right-0">
            <img src="{{ asset('stream/assets/images/success_ellipse_red.svg') }}" alt="stream" />
        </span>
    <!-- ./ -->

    <div class="flex flex-col items-center m-auto pb-20">
        <img src="{{ asset('stream/assets/images/success_page_illustration.png') }}" class="w-[610px] max-w-full" alt="stream" />
